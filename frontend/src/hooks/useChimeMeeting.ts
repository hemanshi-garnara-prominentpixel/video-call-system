...
//         // MeetingSessionConfiguration accepts either the full API response
//         // (with Meeting/Attendee wrapper keys) or the inner objects directly.
//         // Your backend returns the inner objects from StartWebRTCContact's
//         // ConnectionData, so we pass them straight through.
...
//             // Per AWS docs, use isTerminal() to determine if the session
//             // has ended permanently. This covers MeetingEnded,
//             // AudioCallEnded, AudioAttendeeRemoved, AudioCallAtCapacity,
//             // AudioAuthenticationRejected, and other terminal codes.
...
//           // Content share lifecycle — tracks when our own share
//           // is stopped (either by us or overridden by another share)
...
//         //     setIsScreenSharing(false);
//         //     // Remove any stale local content tiles from state
